...
public class UPLanguageParser extends Parser {
	...
	public static final int
		...
		Double=53, Letters=54, Name=55, COMMENT=56, WS=57;
	public static final int
		...
		RULE_result = 23, RULE_delayedResult = 24, RULE_memDivisionResult = 25, 
		RULE_additionalResults = 26, RULE_memCreateResult = 27, RULE_memDissolveResult = 28, 
		RULE_propertyResult = 29, RULE_objResult = 30, RULE_positionResult = 31, 
		RULE_in = 32, RULE_out = 33, RULE_here = 34, RULE_go = 35, RULE_andOpt = 36, 
		RULE_orOpt = 37, RULE_all = 38, RULE_random = 39, RULE_target = 40, RULE_boolCondition = 41, 
		RULE_promoterCondition = 42, RULE_inhibitorCondition = 43, RULE_propertyCondition = 44, 
		RULE_objCondition = 45, RULE_objConditionWithTarget = 46, RULE_priorityCondition = 47, 
		RULE_priority = 48, RULE_probabilisticCondition = 49, RULE_regCondition = 50, 
		RULE_intDim = 51, RULE_abcDim = 52, RULE_formulaDim = 53;
	public static final String[] ruleNames = {
		...
		"ruleName", "condition", "result", "delayedResult", "memDivisionResult", 
		"additionalResults", "memCreateResult", "memDissolveResult", "propertyResult", 
		"objResult", "positionResult", "in", "out", "here", "go", "andOpt", "orOpt", 
		"all", "random", "target", "boolCondition", "promoterCondition", "inhibitorCondition", 
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		null, null, null, null, null, null, null, null, null, null, null, null, 
		null, null, null, null, null, null, null, null, null, null, null, null, 
		null, null, null, null, "Integer", "Double", "Letters", "Name", "COMMENT", 
		"WS"
	};
	...
	public final PruleContext prule() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__11) | (1L << T__32) | (1L << T__47) | (1L << T__48) | (1L << Letters) | (1L << Name))) != 0) );
			setState(323);
			match(T__19);
			setState(327);
			_errHandler.sync(this);
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__11) | (1L << T__22) | (1L << T__23) | (1L << T__25) | (1L << T__27) | (1L << Letters) | (1L << Name))) != 0)) {
				{
				{
				setState(330);
				result();
	...
	public static class DelayedResultContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_delayedResult; }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof UPLanguageVisitor ) return ((UPLanguageVisitor<? extends T>)visitor).visitDelayedResult(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final BoolConditionContext boolCondition() throws RecognitionException {
		...
		try {
			...
			do {
				...
				setState(521);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__11) | (1L << T__16) | (1L << T__18) | (1L << T__23) | (1L << T__24) | (1L << T__29) | (1L << T__30) | (1L << T__36) | (1L << T__37) | (1L << T__38) | (1L << T__39) | (1L << T__40) | (1L << T__41) | (1L << T__42) | (1L << T__43) | (1L << T__44) | (1L << Integer) | (1L << Letters) | (1L << Name))) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__11) | (1L << T__16) | (1L << T__18) | (1L << T__23) | (1L << T__24) | (1L << T__29) | (1L << T__30) | (1L << T__36) | (1L << T__37) | (1L << T__38) | (1L << T__39) | (1L << T__40) | (1L << T__41) | (1L << T__42) | (1L << T__43) | (1L << T__44) | (1L << Integer) | (1L << Letters) | (1L << Name))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final RegConditionContext regCondition() throws RecognitionException {
		...
		try {
			...
			do {
				...
				setState(613);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__2) | (1L << T__6) | (1L << T__10) | (1L << T__11) | (1L << T__13) | (1L << T__14) | (1L << T__16) | (1L << T__20) | (1L << T__23) | (1L << T__24) | (1L << T__37) | (1L << T__50) | (1L << Letters))) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__2) | (1L << T__6) | (1L << T__10) | (1L << T__11) | (1L << T__13) | (1L << T__14) | (1L << T__16) | (1L << T__20) | (1L << T__23) | (1L << T__24) | (1L << T__37) | (1L << T__50) | (1L << Letters))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FormulaDimContext formulaDim() throws RecognitionException {
		...
		try {
			...
			do {
				...
				setState(622);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__11) | (1L << T__16) | (1L << T__18) | (1L << T__23) | (1L << T__24) | (1L << T__36) | (1L << T__37) | (1L << Integer) | (1L << Letters) | (1L << Name))) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__11) | (1L << T__16) | (1L << T__18) | (1L << T__23) | (1L << T__24) | (1L << T__36) | (1L << T__37) | (1L << Integer) | (1L << Letters) | (1L << Name))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"\64\668:<>@BDFHJLNPRTVXZ\\^`bdfhjl\2\b\3\289\5\2\r\16\66\6688\4\2\66\66"+
